...
public class POJO_Producto {
    ...
    public POJO_Producto() {
    }

    public POJO_Producto(String idproducto, int idcategoria, String serie, String nombre, Date f_ingreso, Date f_vencimiento, Double p_venta, Double p_compra) {
