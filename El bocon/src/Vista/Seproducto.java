 ...
 * @author waska
 */
public class Seproducto extends javax.swing.JFrame {
...
// TODO add your handling code here:
  ...
  try {
    ...
    private void editar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editar1ActionPerformed
            try {
        productos2 panel2 = new productos2()
                ;
        panel2.setVisible(true);
        this.dispose();
    } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Seproducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Seproducto().setVisible(true);
            }
        });
    }
