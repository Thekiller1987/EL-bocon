...
int cont;
    ...
    private void btningresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btningresarActionPerformed
        try {
            ...
            CRUD_Usuario func = new CRUD_Usuario();
            POJO_Usuario dts = new POJO_Usuario();
            ...
            if (func.totalregistros >0) {
                ...
                lobby.lblidusuario.setText(tablalistado.getValueAt(0,0).toString());
                lobby.lblnombre.setText(tablalistado.getValueAt(0,2).toString());
                lobby.lblapellidos.setText(tablalistado.getValueAt(0,3).toString());
