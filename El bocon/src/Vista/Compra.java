...
import Modelo.POJO_Compra;
import Modelo.POJO_DetalleCompra;
import Controlador.Funciones;
import Controlador.CRUD_Compra;
import Controlador.CRUD_DetalleCompra;
...
public class Compra extends javax.swing.JInternalFrame{
    ...
    CRUD_Compra func = new CRUD_Compra();

    DefaultTableModel modelo = new DefaultTableModel();

    private void dimencionarImagen() {
        ImageIcon fot = new ImageIcon(getClass().getResource("/Files/logosf.png"));
    ...
    void guardarCompra() {
        POJO_Compra dts = new POJO_Compra();
        int idv = 1;
    ...
    void guardarDetalle() {
        ...
        POJO_DetalleCompra dts = new POJO_DetalleCompra();
        CRUD_DetalleCompra fun = new CRUD_DetalleCompra();
        CRUD_Producto fun1 = new CRUD_Producto();
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtigv, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnbuscarproveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarproveedorActionPerformed
        vistaProveedor form = new vistaProveedor();
        form.toFront();
